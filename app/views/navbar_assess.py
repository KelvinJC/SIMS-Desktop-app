...
class NavBarAssessment(tk.Frame):
    def __init__(self, parent):
        ...
        enroll_button=tk.Button(self, text='Grades & Evaluation', width=20, bg='#394552', bd=0, fg='white', font=('Calibri', 12), anchor=tk.W,
        ...
        nav_button=tk.Button(self, text='Comments', width=20, anchor=tk.W, fg='white', font=("Calibri", 12, 'bold'), bg='#394552', bd=0,
                          command=lambda: self.our_command)
    ...
    def create_assessment(self):
        ...
        if '.!frame.!dashboard.!assessments' in str(self.parent.winfo_children()[1]):
            return
        else:
            for widget in self.parent.winfo_children():
                if '.!navbarassessment' not in repr(widget): # To avoid deleting the navbar widget
